...
class MountainViewComponentTest < ActiveSupport::TestCase
  ...
  def test_component_stubs?
    ...
    compoenet_with_stubs_but_incorrect_format = MountainView::Component.new('card')
    ...
    assert_equal false, compoenet_with_stubs_but_incorrect_format.component_stubs?
  end
  ...
  def test_stubs_extra_info
    ...
    assert_equal expected_extra_info_stub, component_with_extra_info.stubs_extra_info
  ...
  def test_stubs_extra_info?
    ...
    assert_equal false, compoenet_with_stubs_but_incorrect_format.stubs_extra_info?
  end
  ...
  def test_stubs_correct_format?
    ...
    assert_equal false, compoenet_with_stubs_but_incorrect_format.stubs_correct_format?
  end
